  ...
  this.sendImagemap = (userId) => {
    let options = {
            ...
            body: {
              ...
              messages: [{
                "type": "imagemap",
                "baseUrl":"https://i.imgur.com/TytcmOe.png",
...
參考資料：https://developers.line.me/en/docs/messaging-api/reference/#carousel
  ...
  response  {}
*/
  this.sendCarouselTemplate = (userId,altText,thumbnailImageUrl,imageBackgroundColor,title,text,defaultAction,actions) => {
    let options = {
            method: 'POST',
            uri: 'https://api.line.me/v2/bot/message/push',
            headers: {
...
參考資料：https://developers.line.me/en/docs/messaging-api/reference/#carousel
  ...
  userId                String      user id
  altText               String      user received message
  imageUrl              Object      user received image url
                                      Image URL (Max: 1000 characters)
                                      HTTPS
                                      JPEG or PNG
                                      Aspect ratio: 1:1
  ...
  response  {}
*/
  this.sendImageCarouselTemplate = (userId,altText,imageUrl,action) => {
    let options = {
            method: 'POST',
            uri: 'https://api.line.me/v2/bot/message/push',
            headers: {
...
/*
  ...
  response  {}
*/
  this.sendLocationMessage = (userId,title,address,latitude,longitude) => {
    let options = {
            method: 'POST',
            uri: 'https://api.line.me/v2/bot/message/push',
            headers: {
...
/*
  ...
  response  {}
*/
  this.sendConfirmTemplate = (userId,altText,text) => {
    let options = {
            method: 'POST',
            uri: 'https://api.line.me/v2/bot/message/push',
            headers: {
